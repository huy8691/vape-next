...
const UpdateSeller: NextPageWithLayout = () => {
  ...
  return (
    <>
      ...
      >
        <Link href="/supplier/hrm/user-management/list">
          <a>{t('title')}</a>
        </Link>
...
UpdateSeller.getLayout = function getLayout(page: ReactElement) {
  return <NestedLayout>{page}</NestedLayout>
}
UpdateSeller.permissionPage = {
