...
const PreviewEmailOrderBeing: React.FC<{
    ...
    >
      ...
      <Stack direction="column" gap={2}>
        ...
        >
          ...
          >
            The order #[ORDER_CODE] being delivered to the carrier. Please check
            the shipping information in the order details!
          </Typography>
...
export default PreviewEmailOrderBeing
